#!/bin/bash
# Batch stream update experiment for DEEP-1B using SPFresh
#
# Dataset: DEEP-1B (float, 96d, 1B points, 10K queries)
# Data:    /media/tj-yang/T9/data/deep.1B.96.f32.bin      (~358 GB)
# Query:   /media/tj-yang/T9/data/deep.10K.96.f32.query
#
# Usage:
#   bash script/run_deep1b.sh
#
# Build first:
...
DATA_FILE="${DATA_DIR}/deep.1B.96.f32.bin"
QUERY_FILE="${DATA_DIR}/deep.10K.96.f32.query"
...
# Directories
IDX_DIR="/media/tj-yang/T9/index/spfresh_deep1b"
OUT_DIR="/media/tj-yang/T9/result"
OUT_PREFIX="${OUT_DIR}/result_spfresh_deep1b"
...
echo "=== DEEP-1B SPFresh Batch Stream Update Experiment ==="
