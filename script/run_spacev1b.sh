#!/bin/bash
# Batch stream update experiment for SPACEV-1B using SPFresh
#
# Dataset: SPACEV-1B (int8, 100d, 1B points, 29316 queries)
# Data:    /media/tj-yang/T9/data/spacev.1B.100.i8.bin      (~131 GB)
# Query:   /media/tj-yang/T9/data/spacev.29316.100.i8.query
#
# Usage:
#   bash script/run_spacev1b.sh
#
# Build first:
...
DATA_FILE="${DATA_DIR}/spacev.1B.100.i8.bin"
QUERY_FILE="${DATA_DIR}/spacev.29316.100.i8.query"
...
# Directories
IDX_DIR="/media/tj-yang/T9/index/spfresh_spacev1b"
OUT_DIR="/media/tj-yang/T9/result"
OUT_PREFIX="${OUT_DIR}/result_spfresh_spacev1b"
...
echo "=== SPACEV-1B SPFresh Batch Stream Update Experiment ==="
