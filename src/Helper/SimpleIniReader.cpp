...
bool SPTAG::Helper::IniReader::DoesSectionExist(const std::string& p_section) const {
    std::string section(p_section);
    SPTAG::Helper::StrUtils::ToLowerInPlace(section);
    return m_parameters.count(section) != 0;
}

bool SPTAG::Helper::IniReader::DoesParameterExist(const std::string& p_section, const std::string& p_param) const {
...
bool SPTAG::Helper::IniReader::GetRawValue(const std::string& p_section, const std::string& p_param, std::string& p_value) const {
    std::string name(p_section);
    SPTAG::Helper::StrUtils::ToLowerInPlace(name);
...
void SPTAG::Helper::IniReader::SetParameter(const std::string& p_section, const std::string& p_param, const std::string& p_val) {
    std::string name(p_section);
    SPTAG::Helper::StrUtils::ToLowerInPlace(name);
    auto sectionIter = m_parameters.find(name);
